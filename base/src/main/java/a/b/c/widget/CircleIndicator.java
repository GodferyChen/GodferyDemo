...
public class CircleIndicator extends LinearLayout {
	...
	private int mAnimatorResId = R.animator.animator_page_indicator;
	private int mAnimatorReverseResId = 0;
	private int mIndicatorBackgroundResId = R.drawable.selector_page_indicator;
	private int mIndicatorUnselectedBackgroundResId = R.drawable.selector_page_indicator;
	...
	private void handleTypedArray(Context context, AttributeSet attrs) {
		...
		mAnimatorResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_animator, R.animator.animator_page_indicator);
		mAnimatorReverseResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_animator_reverse, 0);
		mIndicatorBackgroundResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable, R.drawable.selector_page_indicator);
	...
	public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
		configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
				R.animator.animator_page_indicator, 0, R.drawable.selector_page_indicator, R.drawable.selector_page_indicator);
	}
	...
	private void checkIndicatorConfig(Context context) {
		...
		mAnimatorResId = (mAnimatorResId == 0) ? R.animator.animator_page_indicator : mAnimatorResId;
		...
		mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.selector_page_indicator
