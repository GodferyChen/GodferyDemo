...
public class StepViewIndicator extends View {
	...
	public StepViewIndicator(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init() {
		...
		array.recycle();
		mProgressColor = colorPrimary;
		mBarColor = 0xFFC7C7C7;
		mLineHeight = 0.05f * THUMB_SIZE;
		mThumbRadius = 0.4f * THUMB_SIZE;
		mCircleRadius = 0.6f * mThumbRadius;
	...
	public void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		if (mDrawListener != null) mDrawListener.onReady();
	}
