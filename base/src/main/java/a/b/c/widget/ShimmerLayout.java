...
public class ShimmerLayout extends FrameLayout {
  ...
  // enum controlling the direction of the highlight mask animation
  public enum MaskAngle {
    leftToRight, // left to right
    topToBottom, // top to bottom
    rightToLeft, // right to left
    bottomToLeft, // bottom to top
  }

  // struct storing various mask related parameters, which are used to construct the mask bitmap
  private static class Mask {

    public MaskAngle direction;
    public float tilt;
  ...
  public ShimmerLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    if (attrs != null) {
      ...
      try {
        if (a.hasValue(R.styleable.ShimmerLayout_autoStart)) {
          setAutoStart(a.getBoolean(R.styleable.ShimmerLayout_autoStart, false));
        }
        if (a.hasValue(R.styleable.ShimmerLayout_baseAlpha)) {
          setBaseAlpha(a.getFloat(R.styleable.ShimmerLayout_baseAlpha, 0));
        }
        if (a.hasValue(R.styleable.ShimmerLayout_duration)) {
          setDuration(a.getInt(R.styleable.ShimmerLayout_duration, 0));
        }
        if (a.hasValue(R.styleable.ShimmerLayout_repeatCount)) {
          setRepeatCount(a.getInt(R.styleable.ShimmerLayout_repeatCount, 0));
        }
        if (a.hasValue(R.styleable.ShimmerLayout_repeatDelay)) {
          setRepeatDelay(a.getInt(R.styleable.ShimmerLayout_repeatDelay, 0));
        }
        if (a.hasValue(R.styleable.ShimmerLayout_repeatMode)) {
          setRepeatMode(a.getInt(R.styleable.ShimmerLayout_repeatMode, 0));
        }

        if (a.hasValue(R.styleable.ShimmerLayout_direction)) {
          int angle = a.getInt(R.styleable.ShimmerLayout_direction, 0);
          switch (angle) {
            default:
            case 0:
              mMask.direction = MaskAngle.leftToRight;
              break;
            case 90:
              mMask.direction = MaskAngle.topToBottom;
              break;
            case 180:
              mMask.direction = MaskAngle.rightToLeft;
              break;
            case 270:
              mMask.direction = MaskAngle.bottomToLeft;
              break;
          }
        }
        ...
        if (a.hasValue(R.styleable.ShimmerLayout_fixedWidth)) {
          mMask.fixedWidth = a.getDimensionPixelSize(R.styleable.ShimmerLayout_fixedWidth, 0);
        }
        if (a.hasValue(R.styleable.ShimmerLayout_fixedHeight)) {
          mMask.fixedHeight = a.getDimensionPixelSize(R.styleable.ShimmerLayout_fixedHeight, 0);
        }
        if (a.hasValue(R.styleable.ShimmerLayout_intensity)) {
          mMask.intensity = a.getFloat(R.styleable.ShimmerLayout_intensity, 0);
        }
        if (a.hasValue(R.styleable.ShimmerLayout_relativeWidth)) {
          mMask.relativeWidth = a.getFloat(R.styleable.ShimmerLayout_relativeWidth, 0);
        }
        if (a.hasValue(R.styleable.ShimmerLayout_relativeHeight)) {
          mMask.relativeHeight = a.getFloat(R.styleable.ShimmerLayout_relativeHeight, 0);
        }
  ...
  /**
   * Get the direction at which the highlight mask is animated. One of:
   * <ul>
   * <li>{@link MaskAngle#leftToRight} which animates left to right,</li>
   * <li>{@link MaskAngle#topToBottom} which animates top to bottom,</li>
   * <li>{@link MaskAngle#rightToLeft} which animates right to left, or</li>
   * <li>{@link MaskAngle#bottomToLeft} which animates bottom to top</li>
   * </ul>
   *
   * @return The {@link MaskAngle} of the current animation
   */
  public MaskAngle getAngle() {
    return mMask.direction;
  }

  /**
   * Set the direction of the highlight mask animation. One of:
   * <ul>
   * <li>{@link MaskAngle#leftToRight} which animates left to right,</li>
   * <li>{@link MaskAngle#topToBottom} which animates top to bottom,</li>
   * <li>{@link MaskAngle#rightToLeft} which animates right to left, or</li>
  ...
  /**
   * Get the tilt direction of the highlight, in degrees. The default value is 20.
   *
   * @return The highlight's tilt direction, in degrees.
   */
  ...
  /**
   * Set the tile direction of the highlight, in degrees.
   *
   * @param tilt The highlight's tilt direction, in degrees.
   */
