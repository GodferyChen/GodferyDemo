...
public class SlidingUpPanelLayout extends ViewGroup {
     ...
     */
    private static final float DEFAULT_ANCHOR_POINT = 0.618f; // In relative %
     ...
     */
    private static final int DEFAULT_SHADOW_HEIGHT = 8; // dp;
     ...
     */
    private static final int DEFAULT_PARALLAX_OFFSET = 96;
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(R.drawable.selector_supl_above_shadow);
            } else {
                mShadowDrawable = getResources().getDrawable(R.drawable.selector_supl_below_shadow);
            }
        } else {
            mShadowDrawable = null;
        }
