...
public class Snackbar extends SnackbarLayout {
    ...
    private SnackBarPosition mPhonePosition = SnackBarPosition.TOP;
     ...
     *
     * @param position A {@link SnackBarPosition}
     ...
     * {@link SnackBarDuration} for available options
     *
     * @param duration
     * @return
     */
...
//        }
//        else {
//            return context.getResources().getBoolean(R.bool.snack_is_phone);
//        }
    }
    ...
    private ViewGroup.MarginLayoutParams init(Context context, Activity targetActivity, ViewGroup parent, boolean usePhoneLayout) {
        SnackbarLayout layout = (SnackbarLayout) LayoutInflater.from(context)
                .inflate(R.layout.layout_snack, this, true);
        layout.setOrientation(LinearLayout.VERTICAL);

        Resources res = getResources();
        mColor = mColor != mUndefinedColor ? mColor : Color.parseColor("#FFFF9800");
        mUsePhoneLayout = usePhoneLayout;
        float scale = res.getDisplayMetrics().density;

        View divider = layout.findViewById(R.id.sb_divider);
        ...
        if (mUsePhoneLayout) {
            ...
            layout.setMinimumWidth(res.getDimensionPixelSize(R.dimen.snack_min_width));
            layout.setMaxWidth(
                    mMaxWidthPercentage == null
                            ? res.getDimensionPixelSize(R.dimen.snack_max_width)
                            : DisplayCompat.getWidthFromPercentage(targetActivity, mMaxWidthPercentage));
            layout.setBackgroundColor(Color.parseColor("#FFFF9800"));
            ...
            if (mLineColor != null) {
                divider.setBackgroundResource(R.drawable.selector_divider_transparent);
        ...
        View inner = layout.findViewById(R.id.sb_inner);
    ...
    private void showInternal(Activity targetActivity, ViewGroup.MarginLayoutParams params, ViewGroup parent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            for (int i = 0; i < parent.getChildCount(); i++) {
                ...
                float elevation = otherChild.getElevation();
    ...
    public static int getInAnimationResource(SnackBarPosition snackbarPosition) {
        return snackbarPosition == SnackBarPosition.TOP ? R.anim.snack_top_in : R.anim.snack_bottom_in;
    }
    ...
    public static int getOutAnimationResource(SnackBarPosition snackbarPosition) {
        return snackbarPosition == SnackBarPosition.TOP ? R.anim.snack_top_out : R.anim.snack_bottom_out;
    }
