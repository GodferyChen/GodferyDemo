...
public class ScaleImageView extends View {
	...
	private static class BitmapLoadTask extends AsyncTask<Void, Void, Integer> {
		...
		public BitmapLoadTask(ScaleImageView view, Context context, DecoderFactory<? extends ImageDecoder> decoderFactory, Uri source, boolean preview) {
			this.viewRef = new WeakReference<ScaleImageView>(view);
			this.contextRef = new WeakReference<Context>(context);
		...
		protected Integer doInBackground(Void... params) {
			try {
				...
				if (context != null && decoderFactory != null && scaleImageView != null) {
                    ...
                    return scaleImageView.getExifOrientation(sourceUri);
				}
			} catch (Exception e) {
			...
			if (scaleImageView != null) {
				if (bitmap != null && orientation != null) {
					if (preview) {
						...
						scaleImageView.onImageLoaded(bitmap, orientation);
					}
				} else if (exception != null && scaleImageView.onImageEventListener != null) {
					if (preview) {
