...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int mTabBackgroundResId = R.drawable.selector_pressed_transparent;
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (isCustomTabs) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(R.layout.layout_psts_tab, this, false);
            }
